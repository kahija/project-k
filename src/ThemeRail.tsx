...
export function ThemeRail({ theme, setTheme }: { theme: Theme; setTheme: (theme: Theme) => void }) {
  ...
  return (
    <aside aria-label="Apparence" className={`transition-colors duration-700 fixed bottom-0 left-0 top-20 z-40 hidden w-[72px] items-center justify-center border-r md:flex ${dark ? "border-white/10 bg-[#050507]/95 text-white" : "border-black/10 bg-[#f5f0ea]/95 text-[#18151d]"}`}>
